...
func Migrate(c *cli.Context) error {
	...
	fmt.Println("  2. Generate new post-quantum keypair (ML-DSA-65 + ML-KEM-768)")
	fmt.Println("  3. Re-encrypt your master key with the post-quantum key")
	...
	fmt.Println("  Auth:       ML-DSA-65 (FIPS 204)")
